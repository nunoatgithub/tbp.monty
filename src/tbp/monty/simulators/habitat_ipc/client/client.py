...
class HabitatClient(Simulator):
    ...
    @staticmethod
    def _agent_cfg_to_proto(agent_cfg: dict) -> habitat_pb2.HabitatAgentConfig:
        ...
        if "sensor_id" in agent_args:
            ...
            single_sensor_cfg = habitat_pb2.HabitatAgentConfig.SingleSensorConfig(
                ...
                resolution=basic_types_pb2.Resolution(
                    height=resolution[0],
                    width=resolution[1]
                )
            )
            ...
            if "rotations" in agent_args:
                for rot in agent_args["rotations"]:
                    rotation = basic_types_pb2.QuaternionWXYZ(w=rot[0], x=rot[1], y=rot[2],
                                                              z=rot[3])
